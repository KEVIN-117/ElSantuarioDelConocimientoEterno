...
public class GradeStudent extends Panel{
    ...
    private Field field;
    private Table table;
    public GradeStudent(ManagementGrade managementGrade) {
    ...
    public GradeStudent(Point point, Dimension size, Color color) {
    ...
    private void loadLayout() {
        ...
        String[] headers = {"Ci", "Nombres ", "Estado", "Promedio"};
    ...
    public void loadData(ArrayList<Student> data){
        ...
        data.forEach((item)->{
            ...
            if (item.getAverage() > 50)
                dataRow[2] = "Aprovado";
            else
                dataRow[2] = "reprovado";

            dataRow[3] = item.getAge().toString();
            //"Ci", "Nombres ", "Estado", "Promedio"
